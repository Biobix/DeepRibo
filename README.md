...
The output file is an extension of the `data_list.csv` file created when parsing the data. More information about each column is provided in the [Supplementary Information and Figures](https://academic.oup.com/nar/advance-article/doi/10.1093/nar/gkz061/5310036?guestAccessKey=885192a5-1c4e-4831-89cf-44dc2f2dcc89). In case a custom model architecture was used to train a model, it is important to give this information to the script using the related arguments.
